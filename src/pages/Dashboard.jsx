  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 animate-fade-in-up animate-delay-200">
        <div className="bg-gradient-to-br from-white/80 to-white/40 backdrop-blur-sm rounded-2xl p-6 border border-white/30 shadow-lg hover:shadow-xl transition-all duration-300">
          <div className="flex items-center justify-between">
            <div>
      ...
      <div className="flex items-center justify-between animate-fade-in-up animate-delay-300">
        ...
        <button
          ...
          className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white font-bold rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-300 space-x-2"
        >
          ...
          {courses.map((course, index) => (
            <div key={course.id} className={`group relative overflow-hidden bg-white/90 backdrop-blur-md rounded-3xl shadow-xl hover:shadow-2xl border border-white/40 transition-all duration-500 hover:-translate-y-3 animate-fade-in-up animate-delay-${(index % 3 + 1) * 100}`}>
              ...
              <div className="relative z-10 p-8">
                ...
                {/* Course Details */}
                <div className="space-y-3 mb-6 p-4 bg-gradient-to-br from-slate-50 to-white rounded-xl border border-slate-100">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex space-x-2">
                    ...
                    <button
                      ...
                      className="flex-1 flex items-center justify-center space-x-2 px-4 py-2 text-sm font-bold bg-gradient-to-r from-purple-100 to-pink-100 text-purple-700 hover:from-purple-200 hover:to-pink-200 border border-purple-200 rounded-lg transition-all duration-300"
                    >
                    ...
                    <button
                      ...
                      className="flex items-center justify-center px-3 py-2 text-sm font-bold bg-gradient-to-r from-red-100 to-pink-100 text-red-700 hover:from-red-200 hover:to-pink-200 border border-red-200 rounded-lg transition-all duration-300"
                    >
